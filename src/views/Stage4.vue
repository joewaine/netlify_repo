																...
																<section class="justify-content-center">
																		...
																		<div class="col-lg-6 col-md-12 no-lr-pad btm-pad-xxl bg-glasses mobile-image">
																							...
																							<p class="top-pad-lg">
																																								...
																																								<p><span class="bold">Next:	<router-link id="url:sales-story-page" to="/salesstory" class=""><span style="text-decoration: underline;">Sales Story</span></router-link></span></p>
																																				</div>
																																</div>
																												</div>
																								</div>
								...
								return {
												options: {
																...
																afterLoad: function(origin, destination) {
																				...
																				if (slideRight) {
																								for (var ixx = 0; ixx < slideRight.length; ++ixx) {
																												slideRight[ixx].classList.remove('slide-in-right');
																								}
																				}
																				...
																				if (destination.index) {
																								...
																								if (destination.index == 1) {
																												var chartBar2 = document.querySelectorAll('.chart__bar-4');
																												if (chartBar2) {
																																for (var ijj = 0; ijj < chartBar2.length; ++ijj) {
																																				chartBar2[ijj].classList.add('running-4');
																																}
																												}
																								}

		...
		<section class="share-slider__content">
			...
			<div class="share-slider__content__text">
				<a
					...
					href="mailto:?subject=Dynamics 365 Savvy Sales Leaders Guide&body=Check out the Dynamics 365 Savvy Sales Leaders Guide: https%3A%2F%2Fdiscover.microsoft.com%2Fdynamics365-savvy-sales-leaders-guide-ebook%2F"
					@click="toggleClass"
				>
					<svg
						width="29"
				...
				<a
					...
					data-bi-area="fixed-side-slider-module"
					data-bi-bhvr="SOCIALSHARE"
					data-bi-socchn="copy-url-share​"
					id="social-share-copy-url"
					@click="copyUrl"
				>
					<svg
						id="copySvg"
